...
contract ZivoeMath {
    ...
    function juniorProportion(uint256 eSTT, uint256 eJTT, uint256 sP, uint256 Q) external pure returns (uint256 jP) {
        if (sP <= RAY) jP = (Q * eJTT * sP / BIPS).floorDiv(eSTT).min(RAY - sP);    //  a < b ? a : b;
    }
     ...
     */
    function seniorProportion(uint256 yD, uint256 yT, uint256 eSTT, uint256 eJTT, uint256 Y, uint256 Q, uint256 T)
        external
        pure
        returns (uint256 sP)
    {
     ...
     */
    function yieldTarget(uint256 eSTT, uint256 eJTT, uint256 Y, uint256 Q, uint256 T)
        public
        pure
        returns (uint256 yT)
    {
