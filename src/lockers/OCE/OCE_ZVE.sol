...
contract OCE_ZVE is ZivoeLocker, ReentrancyGuard {
    ...
    uint256 public exponentialDecayPerSecond = RAY * 99999999 / 100000000;

    /// @dev The rate of decay per second.
    uint256 public lastDistribution;
    /// @dev The block.timestamp value of last distribution.
    ...
    function forwardEmissions() external nonReentrant {
        uint256 zveBalance = IERC20(IZivoeGlobals_OCE_ZVE(GBL).ZVE()).balanceOf(address(this));
    ...
    function _forwardEmissions(uint256 amount) private {
        ...
        uint256 amountZero = amount * distributionRatioBIPS[0] / BIPS;
        uint256 amountOne = amount * distributionRatioBIPS[1] / BIPS;
        uint256 amountTwo = amount * distributionRatioBIPS[2] / BIPS;
