...
contract OCY_Convex_B is ZivoeLocker, ReentrancyGuard {
    ...
    /// @dev Index 2, BasePool
    address public constant sUSD = 0x57Ab1ec28D129707052df4dF418D58a2D46d5f51;
    /// @dev Index 3, BasePool
    ...
    function pullFromLocker(address asset, bytes calldata data) external override onlyOwner {
        ...
        (uint256 _bp_min0, uint256 _bp_min1, uint256 _bp_min2, uint256 _bp_min3) =
        ...
        if (extra) {
            ...
            for (uint256 i = 0; i < extraRewardsLength; i++) {
                ...
                uint256 rewardAmount =
                    IBaseRewardPool_OCY_Convex_B(rewardContract).rewardToken().balanceOf(address(this));
